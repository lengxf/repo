...
setx GRADLE_HOME  "D:\Android\gradle"

setx Meld "D:\Android\Meld"
...
setx PATH "%%PATH%%;%%JAVA_SDK_HOME%%\bin;%%ANDROID_SDK_HOME%%\tools;%%ANDROID_SDK_HOME%%\platform-tools;%%GRADLE_HOME%%\bin;%%MYBIN%%;%%Meld%%"
pause
